...
6. [DNS-инфраструктура (продолжение 4 шага)](#ch6)
7. [Политика межсетевого экрана на шлюзе](#ch7)
8. [Развёртывание веб-приложения в Docker на сервере `srv`](#ch8)
9. [Развёртывание веб-приложения на сервере `srv`](#ch9)
10. [Настройка отказоустойчивого файлового хранилища и сетевых шар](#ch10)
11. [Центр сертификации, HTTPS](#ch11)
