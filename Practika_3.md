...
1. [Вводные данные и технические параметры](#1-вводные-данные-и-технические-параметры)
2. [Подготовка виртуального стенда и базовая маршрутизация](#2-подготовка-виртуального-стенда-и-базовая-маршрутизация)
3. [Настройка DHCP, SSH, Sudo и локальных учётных записей](#3-настройка-dhcp-ssh-sudo-и-локальных-учётных-записей)
4. [Автоматизация развёртывания с помощью Ansible](#4-автоматизация-развёртывания-с-помощью-ansible)
5. [Настройка синхронизации времени](#5-настройка-синхронизации-времени)
6. [Контроллер домена Samba DC и групповые политики](#6-контроллер-домена-samba-dc-и-групповые-политики)
7. [DNS-инфраструктура (продолжение 4 шага)](#7-dns-инфраструктура-продолжение-4-шага)
8. [Политика межсетевого экрана на шлюзе](#8-политика-межсетевого-экрана-на-шлюзе)
9. [Развёртывание веб-приложения в Docker на сервере `srv`](#9-развёртывание-веб-приложения-в-docker-на-сервере-srv)
10. [Развёртывание веб-приложения на сервере `srv`](#10-развёртывание-веб-приложения-на-сервере-srv)
11. [Настройка отказоустойчивого файлового хранилища и сетевых шар](#11-настройка-отказоустойчивого-файлового-хранилища-и-сетевых-шар)
12. [Центр сертификации, HTTPS](#12-центр-сертификации-https)
