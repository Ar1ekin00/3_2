...
1. [Вводные данные и технические параметры](#ch1)
2. [Подготовка виртуального стенда и базовая маршрутизация](#ch2)
3. [Настройка DHCP, SSH, Sudo и локальных учётных записей](#ch3)
4. [Автоматизация развёртывания с помощью Ansible](#ch4)
5. [Настройка синхронизации времени](#ch5)
6. [Контроллер домена Samba DC и групповые политики](#ch6)
7. [DNS-инфраструктура (продолжение 4 шага)](#ch7)
8. [Политика межсетевого экрана на шлюзе](#ch8)
9. [Развёртывание веб-приложения в Docker на сервере `srv`](#ch9)
10. [Развёртывание веб-приложения на сервере `srv`](#ch10)
11. [Настройка отказоустойчивого файлового хранилища и сетевых шар](#ch11)
12. [Центр сертификации, HTTPS](#ch12)
